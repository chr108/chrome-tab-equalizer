...
- **Distortion Mode** : Soft / Hard を切り替え
...
5. Distortion を有効化し、Drive / Amount / Mode / Output Gain を調整する
...
- WaveShaperNode の `oversample` は `"4x"`
- Soft は滑らかな飽和、Hard は強いクリップ感のあるカーブを使用
